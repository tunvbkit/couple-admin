	...
	<div class="row">
		<div class="col-xs-10 col-md-offset-1">
			...
			<div class="form-range">
					<form action="{{URL::route('update-range',array($range->id))}}" class="form-horizontal" method="post" id="add-range">
						<div class="form-group">
							<label class="col-sm-2 control-label">Min</label>
							<div class="col-sm-10">
							<input type="text" class="form-control" id="min" name="min" value="{{$range->min}}">
							</div>
						</div>
						<div class="form-group">
						 <label class="col-sm-2 control-label">Max</label>
						 <div class="col-sm-10">
							<input type="text" class="form-control" id="max" name="max" value="{{$range->max}}">
							</div>
						</div>
						<div class="form-group">
